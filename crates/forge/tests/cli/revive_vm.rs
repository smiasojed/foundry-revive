...
Traces:
  [..] CounterTest::setUp()
    ├─ [..] → new <unknown>@0x34A1D3fff3958843C43aD80F30b94c510645C316
    │   └─ ← [Return] [..] bytes of code
    ├─ [..] VM::expectEmit()
    │   └─ ← [Return]
    ├─ emit SetNumber(result: 5)
    ├─ [..] 0x34A1D3fff3958843C43aD80F30b94c510645C316::setNumber(5)
    │   ├─ emit SetNumber(result: 5)
    │   └─ ← [Stop]
    ├─ [..] 0x34A1D3fff3958843C43aD80F30b94c510645C316::number() [staticcall]
    │   └─ ← [Return] 5
    └─ ← [Stop]
  ...
  [..] CounterTest::test_Increment()
    ├─ [..] 0x34A1D3fff3958843C43aD80F30b94c510645C316::number() [staticcall]
    │   └─ ← [Return] 5
    ├─ [..] 0x34A1D3fff3958843C43aD80F30b94c510645C316::setNumber(55)
    │   ├─ emit SetNumber(result: 55)
    │   └─ ← [Stop]
    ├─ [..] 0x34A1D3fff3958843C43aD80F30b94c510645C316::number() [staticcall]
    │   └─ ← [Return] 55
    ├─ [..] 0x34A1D3fff3958843C43aD80F30b94c510645C316::increment()
...
Traces:
  ...
  [..] CounterTest::test_expectRevert()
    ...
    │   └─ ← [Return]
    ├─ [..] 0x34A1D3fff3958843C43aD80F30b94c510645C316::failed_call() [staticcall]
    │   └─ ← [Revert] Revert("failure")
    └─ ← [Stop]
...
Traces:
  [..] RecordTest::testRecordAccess()
    ├─ [..] → new <unknown>@0x34A1D3fff3958843C43aD80F30b94c510645C316
    │   └─ ← [Return] [..] bytes of code
    ├─ [..] → new <unknown>@0x90193C961A926261B756D1E5bb255e67ff9498A1
    │   └─ ← [Return] [..] bytes of code
    ├─ [..] VM::record()
    │   └─ ← [Return]
    ├─ [..] 0x34A1D3fff3958843C43aD80F30b94c510645C316::record(0x90193C961A926261B756D1E5bb255e67ff9498A1)
    │   ├─ [..] 0x90193C961A926261B756D1E5bb255e67ff9498A1::record()
    │   │   └─ ← [Return]
    │   └─ ← [Stop]
    ...
    ├─ [..] VM::accesses(0x90193C961A926261B756D1E5bb255e67ff9498A1)
...
Traces:
  ...
  [..] RecordLogsTest::testRecordOffGetsNothing()
    ├─ [..] 0x34A1D3fff3958843C43aD80F30b94c510645C316::emitEvent(1, 2, 3, 0x43a26051362b8040b289abe93334a5e3662751aa691185ae9e9a2e1e0c1693502e38edeff9493e0004540e975027a429)
...
Traces:
  ...
  [..] RecordLogsTest::testRecordOnEmitDifferentDepths()
    ...
    ├─ [..] 0x34A1D3fff3958843C43aD80F30b94c510645C316::emitEvent(2, 3, 0x43a26051362b8040b289abe93334a5e3662751aa)
    ...
    │   ├─ [..] 0xd04404bcf6d969FC0Ec22021b4736510CAcec492::emitEvent(4, 5, 6, 0x43a26051362b8040b289abe93334a5e3662751aa691185ae)
    ...
    ├─ [..] 0x90193C961A926261B756D1E5bb255e67ff9498A1::getEmitterAddr() [staticcall]
...
Traces:
  ...
  [..] RecordLogsTest::testRecordOnSingleLog()
    ├─ [..] VM::recordLogs()
    │   └─ ← [Return]
    ├─ [..] 0x34A1D3fff3958843C43aD80F30b94c510645C316::emitEvent(1, 2, 3, 0x4576656e74204461746120696e20537472696e67)
...
Traces:
  ...
  [..] RecordLogsTest::testRecordsConsumednAsRead()
    ...
    ├─ [..] VM::getRecordedLogs()
    │   └─ ← [Return] []
    ├─ [..] 0x34A1D3fff3958843C43aD80F30b94c510645C316::emitEvent(2, 3, 0x43a26051362b8040b289abe93334a5e3662751aa691185ae)
    ...
    ├─ [..] 0x34A1D3fff3958843C43aD80F30b94c510645C316::emitEvent(7, 8, 9, 0x2e38edeff9493e0004540e975027a429ee666d1289f2c7a4)
...
Traces:
  ...
  [..] StateDiffTest::testCallProxyaccesses()
    ├─ [..] VM::startStateDiffRecording()
    │   └─ ← [Return]
    ├─ [..] 0x90193C961A926261B756D1E5bb255e67ff9498A1::proxyCall(55)
    │   ├─ [..] 0x34A1D3fff3958843C43aD80F30b94c510645C316::setter(55)
    │   │   └─ ← [Return]
    │   └─ ← [Stop]
...
Traces:
  ...
  [..] StateDiffTest::testCreateaccesses()
    ├─ [..] VM::startStateDiffRecording()
    │   └─ ← [Return]
    ├─ [..] → new <unknown>@0xA8452Ec99ce0C64f20701dB7dD3abDb607c00496
    │   └─ ← [Return] [..] bytes of code
    ├─ [..] VM::stopAndReturnStateDiff()
